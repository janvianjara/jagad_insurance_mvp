...
3. Polish pass from the gallery: every list has loading/empty/error states; focus visible
   everywhere; labels on all inputs; no emoji anywhere; `check:tokens` still clean.
4. Tag `v0.1.0-m0`.
