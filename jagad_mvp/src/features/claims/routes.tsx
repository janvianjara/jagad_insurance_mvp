 ...
 */
export const ClaimQueueRoute = lazy(() => import('./ClaimQueueScreen'))
export const ClaimIntimationRoute = lazy(() => import('./ClaimIntimationScreen'))
export const ClaimDetailRoute = lazy(() => import('./ClaimDetailScreen'))
